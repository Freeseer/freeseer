...
#
# Created: Tue Feb 15 19:18:55 2011
...
class Ui_ConfigureTool(object):
    def setupUi(self, ConfigureTool):
        ...
        ConfigureTool.setTabOrder(self.lineEdit_recordKey, self.lineEdit_stopKey)
        ConfigureTool.setTabOrder(self.lineEdit_stopKey, self.lineEdit_videoDirectory)
