...
class Ui_ConfigureTool(object):
    def setupUi(self, ConfigureTool):
        ...
        self.radioButton_localDesktop.setEnabled(False)
        ...
        self.radioButton_hardware.setEnabled(False)
        ...
        self.lineEdit_record = QtGui.QLineEdit(self.layoutWidget_4)
        self.lineEdit_record.setObjectName("lineEdit_record")
        self.gridLayout_Shorkeys.addWidget(self.lineEdit_record, 0, 1, 1, 1)
        self.lineEdit_stop = QtGui.QLineEdit(self.layoutWidget_4)
        self.lineEdit_stop.setObjectName("lineEdit_stop")
        self.gridLayout_Shorkeys.addWidget(self.lineEdit_stop, 1, 1, 1, 1)
        ...
        self.label_record.setBuddy(self.lineEdit_record)
        self.label_stop.setBuddy(self.lineEdit_stop)
        ...
        ConfigureTool.setTabOrder(self.pushButton_apply, self.pushButton_reset)
        ConfigureTool.setTabOrder(self.pushButton_reset, self.configureTab)
        ConfigureTool.setTabOrder(self.configureTab, self.radioButton_localDesktop)
        ...
        ConfigureTool.setTabOrder(self.lineEdit_URL_IP, self.lineEdit_port)
        ConfigureTool.setTabOrder(self.lineEdit_port, self.lineEdit_mountPoint)
        ConfigureTool.setTabOrder(self.lineEdit_mountPoint, self.lineEdit_password)
        ConfigureTool.setTabOrder(self.lineEdit_password, self.checkbox_autoHide)
        ConfigureTool.setTabOrder(self.checkbox_autoHide, self.lineEdit_record)
        ConfigureTool.setTabOrder(self.lineEdit_record, self.lineEdit_stop)
        ConfigureTool.setTabOrder(self.lineEdit_stop, self.lineEdit_videoDirectory)
...
"v4l2src does not work.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.comboBox_videoQualityList.setItemText(1, QtGui.QApplication.translate("ConfigureTool", "360P(Low)", None, QtGui.QApplication.UnicodeUTF8))
