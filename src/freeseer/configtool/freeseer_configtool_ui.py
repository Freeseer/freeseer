...
#
# Created: Sun Apr  3 20:50:42 2011
...
class Ui_ConfigureTool(object):
    def setupUi(self, ConfigureTool):
        ...
        self.groupBox_hardware.setEnabled(True)
        ...
        self.tableWidget_screenResolution.setSelectionMode(QtGui.QAbstractItemView.NoSelection)
        ...
        self.groupBox_streaming = QtGui.QGroupBox(self.tab)
        self.groupBox_streaming.setEnabled(True)
        self.groupBox_streaming.setGeometry(QtCore.QRect(10, 10, 531, 381))
        self.groupBox_streaming.setCheckable(True)
        self.groupBox_streaming.setChecked(False)
        self.groupBox_streaming.setObjectName("groupBox_streaming")
        self.layoutWidget_7 = QtGui.QWidget(self.groupBox_streaming)
        ...
        self.pushButton_testStreaming = QtGui.QPushButton(self.groupBox_streaming)
        ...
        self.horizontalLayoutWidget_2 = QtGui.QWidget(self.groupBox_streaming)
        ...
        QtCore.QObject.connect(self.groupBox_streaming, QtCore.SIGNAL("toggled(bool)"), self.pushButton_testStreaming.setEnabled)
...
"v4l2src does not work.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox_soundSource.setTitle(QtGui.QApplication.translate("ConfigureTool", "Enable Audio Recoding", None, QtGui.QApplication.UnicodeUTF8))
        self.label_soundSource.setText(QtGui.QApplication.translate("ConfigureTool", "&Audio Source", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.configureTab.setTabText(self.configureTab.indexOf(self.SourceSetting), QtGui.QApplication.translate("ConfigureTool", "Source Settings", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_videoQuality.setText(QtGui.QApplication.translate("ConfigureTool", "Video Resolution", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.comboBox_videoQualityList.setItemText(1, QtGui.QApplication.translate("ConfigureTool", "240p", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_videoQualityList.setItemText(2, QtGui.QApplication.translate("ConfigureTool", "360p", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_videoQualityList.setItemText(3, QtGui.QApplication.translate("ConfigureTool", "480p", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_videoQualityList.setItemText(4, QtGui.QApplication.translate("ConfigureTool", "720p", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_videoQualityList.setItemText(5, QtGui.QApplication.translate("ConfigureTool", "1080p", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.configureTab.setTabText(self.configureTab.indexOf(self.Videosetting), QtGui.QApplication.translate("ConfigureTool", "Video settings", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_streaming.setTitle(QtGui.QApplication.translate("ConfigureTool", "&Enable Streaming ", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.pushButton_testStreaming.setToolTip(QtGui.QApplication.translate("ConfigureTool", "Press this to test streaming setting", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label.setText(QtGui.QApplication.translate("ConfigureTool", "Streaming Resolution", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.comboBox_streamingQualityList.setItemText(1, QtGui.QApplication.translate("ConfigureTool", "240p", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_streamingQualityList.setItemText(2, QtGui.QApplication.translate("ConfigureTool", "360p", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_streamingQualityList.setItemText(3, QtGui.QApplication.translate("ConfigureTool", "480p", None, QtGui.QApplication.UnicodeUTF8))
        self.configureTab.setTabText(self.configureTab.indexOf(self.tab), QtGui.QApplication.translate("ConfigureTool", "Steaming settings", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.pushButton_recodrdKey.setToolTip(QtGui.QApplication.translate("ConfigureTool", "Press this to set record shot key", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_recodrdKey.setText(QtGui.QApplication.translate("ConfigureTool", "...", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_StopKey.setToolTip(QtGui.QApplication.translate("ConfigureTool", "Press this to set record stop key", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.configureTab.setTabText(self.configureTab.indexOf(self.Extrasetting), QtGui.QApplication.translate("ConfigureTool", "Extra settings", None, QtGui.QApplication.UnicodeUTF8))
