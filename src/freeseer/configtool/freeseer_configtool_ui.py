...
#
# Created: Tue Feb 22 20:48:13 2011
...
class Ui_ConfigureTool(object):
    def setupUi(self, ConfigureTool):
        ...
        self.groupBox_enableStreaming = QtGui.QGroupBox(self.groupBox_videoQuality)
        self.groupBox_enableStreaming.setEnabled(True)
        self.groupBox_enableStreaming.setGeometry(QtCore.QRect(10, 120, 521, 261))
        ...
        self.layoutWidget_7.setGeometry(QtCore.QRect(10, 20, 511, 201))
        ...
        self.label_pass_4 = QtGui.QLabel(self.layoutWidget_7)
        self.label_pass_4.setText("")
        self.label_pass_4.setPixmap(QtGui.QPixmap(":/streamingCheck/pass.png"))
        self.label_pass_4.setObjectName("label_pass_4")
        self.gridLayout_EnableStreaming.addWidget(self.label_pass_4, 3, 3, 1, 1)
        self.label_unknow_4 = QtGui.QLabel(self.layoutWidget_7)
        self.label_unknow_4.setText("")
        self.label_unknow_4.setPixmap(QtGui.QPixmap(":/streamingCheck/unknow.png"))
        self.label_unknow_4.setObjectName("label_unknow_4")
        self.gridLayout_EnableStreaming.addWidget(self.label_unknow_4, 3, 2, 1, 1)
        self.label_pass_3 = QtGui.QLabel(self.layoutWidget_7)
        self.label_pass_3.setText("")
        self.label_pass_3.setPixmap(QtGui.QPixmap(":/streamingCheck/pass.png"))
        self.label_pass_3.setObjectName("label_pass_3")
        self.gridLayout_EnableStreaming.addWidget(self.label_pass_3, 2, 3, 1, 1)
        self.label_unknow_3 = QtGui.QLabel(self.layoutWidget_7)
        self.label_unknow_3.setText("")
        self.label_unknow_3.setPixmap(QtGui.QPixmap(":/streamingCheck/unknow.png"))
        self.label_unknow_3.setScaledContents(False)
        self.label_unknow_3.setObjectName("label_unknow_3")
        self.gridLayout_EnableStreaming.addWidget(self.label_unknow_3, 2, 2, 1, 1)
        self.label_12 = QtGui.QLabel(self.layoutWidget_7)
        self.label_12.setText("")
        self.label_12.setPixmap(QtGui.QPixmap(":/streamingCheck/error.png"))
        self.label_12.setObjectName("label_12")
        self.gridLayout_EnableStreaming.addWidget(self.label_12, 3, 4, 1, 1)
        self.label_error_3 = QtGui.QLabel(self.layoutWidget_7)
        self.label_error_3.setText("")
        self.label_error_3.setPixmap(QtGui.QPixmap(":/streamingCheck/error.png"))
        self.label_error_3.setObjectName("label_error_3")
        self.gridLayout_EnableStreaming.addWidget(self.label_error_3, 2, 4, 1, 1)
        self.label_error_2 = QtGui.QLabel(self.layoutWidget_7)
        self.label_error_2.setText("")
        self.label_error_2.setPixmap(QtGui.QPixmap(":/streamingCheck/error.png"))
        self.label_error_2.setObjectName("label_error_2")
        self.gridLayout_EnableStreaming.addWidget(self.label_error_2, 1, 4, 1, 1)
        self.label_pass_2 = QtGui.QLabel(self.layoutWidget_7)
        self.label_pass_2.setText("")
        self.label_pass_2.setPixmap(QtGui.QPixmap(":/streamingCheck/pass.png"))
        self.label_pass_2.setObjectName("label_pass_2")
        self.gridLayout_EnableStreaming.addWidget(self.label_pass_2, 1, 3, 1, 1)
        self.label_unknow_2 = QtGui.QLabel(self.layoutWidget_7)
        self.label_unknow_2.setText("")
        self.label_unknow_2.setPixmap(QtGui.QPixmap(":/streamingCheck/unknow.png"))
        self.label_unknow_2.setObjectName("label_unknow_2")
        self.gridLayout_EnableStreaming.addWidget(self.label_unknow_2, 1, 2, 1, 1)
        self.label_error_1 = QtGui.QLabel(self.layoutWidget_7)
        self.label_error_1.setText("")
        self.label_error_1.setPixmap(QtGui.QPixmap(":/streamingCheck/error.png"))
        self.label_error_1.setObjectName("label_error_1")
        self.gridLayout_EnableStreaming.addWidget(self.label_error_1, 0, 4, 1, 1)
        self.label_pass_1 = QtGui.QLabel(self.layoutWidget_7)
        self.label_pass_1.setText("")
        self.label_pass_1.setPixmap(QtGui.QPixmap(":/streamingCheck/pass.png"))
        self.label_pass_1.setObjectName("label_pass_1")
        self.gridLayout_EnableStreaming.addWidget(self.label_pass_1, 0, 3, 1, 1)
        self.label_unknow_1 = QtGui.QLabel(self.layoutWidget_7)
        self.label_unknow_1.setText("")
        self.label_unknow_1.setTextFormat(QtCore.Qt.AutoText)
        self.label_unknow_1.setPixmap(QtGui.QPixmap(":/streamingCheck/unknow.png"))
        self.label_unknow_1.setScaledContents(False)
        self.label_unknow_1.setObjectName("label_unknow_1")
        self.gridLayout_EnableStreaming.addWidget(self.label_unknow_1, 0, 2, 1, 1)
        self.pushButton_testStreaming = QtGui.QPushButton(self.groupBox_enableStreaming)
        self.pushButton_testStreaming.setGeometry(QtCore.QRect(430, 230, 96, 28))
        ...
        QtCore.QObject.connect(self.lineEdit_URL_IP, QtCore.SIGNAL("textChanged(QString)"), self.label_unknow_1.show)
...
"v4l2src does not work.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.comboBox_videoQualityList.setItemText(4, QtGui.QApplication.translate("ConfigureTool", "1920x1080", None, QtGui.QApplication.UnicodeUTF8))
