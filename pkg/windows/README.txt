- If you want to install Freeseer's dependencies and compile it from the source: 
    - Run the file installDependencies.bat as Administrator

- If you want to package Freeseer on a zip/rar file:
